view: meeting_finder_upload__1__get_locations_v002 {
  sql_table_name: wwi_processed_data.meeting_finder_upload__1__getLocations_v002 ;;
...
view: meeting_finder_upload__1__getLocations_v002__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: meeting_finder_upload__1__getLocations_v002__payload {
  dimension: id {
    primary_key: yes
    type: number
    sql: ${TABLE}.id ;;
...
view: meeting_finder_upload__1__getLocations_v002__payload__open_hours {
  dimension: id {
    primary_key: yes
    type: number
    sql: ${TABLE}.id ;;
...
view: meeting_finder_upload__1__getLocations_v002__payload__open_hours__meeting_day {
  dimension: id {
    primary_key: yes
    type: number
    sql: ${TABLE}.id ;;
...
view: meeting_finder_upload__1__getLocations_v002__payload__address {
  dimension: _geoloc {
    hidden: yes
    sql: ${TABLE}._geoloc ;;
  }
...
view: meeting_finder_upload__1__getLocations_v002__payload__address___geoloc {
  dimension: lat {
    type: string
    sql: ${TABLE}.lat ;;
  }
...
view: meeting_finder_upload__1__getLocations_v002__payload__meetings {
  dimension: id {
    primary_key: yes
    type: number
    sql: ${TABLE}.id ;;
...
view: meeting_finder_upload__1__getLocations_v002__payload__meetings__meeting_leader {
  dimension: id {
    primary_key: yes
    type: string
    sql: ${TABLE}.id ;;
...
view: meeting_finder_upload__1__getLocations_v002__payload__meetings__meeting_leader__profile_items {
...
view: meeting_finder_upload__1__getLocations_v002__payload__meetings__meeting_day {
  dimension: id {
    primary_key: yes
    type: number
    sql: ${TABLE}.id ;;
...
view: meeting_finder_upload__1__getLocations_v002__payload__meetings__meeting_type {
  dimension: id {
    primary_key: yes
    type: number
    sql: ${TABLE}.id ;;
...
view: meeting_finder_upload__1__getLocations_v002__payload__price_zone {
  dimension: id {
    primary_key: yes
    type: string
    sql: ${TABLE}.id ;;
