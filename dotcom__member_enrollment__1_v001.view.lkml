view: dotcom__member_enrollment__1_v001 {
  sql_table_name: wwi_processed_data.dotcom__MEMBER_ENROLLMENT__1_v001 ;;
...
view: dotcom__MEMBER_ENROLLMENT__1_v001__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: dotcom__MEMBER_ENROLLMENT__1_v001__payload {
