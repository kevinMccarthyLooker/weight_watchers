view: champ__member_profile__1_v001 {
  sql_table_name: wwi_processed_data.champ__MEMBER_PROFILE__1_v001 ;;
...
view: champ__MEMBER_PROFILE__1_v001__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: champ__MEMBER_PROFILE__1_v001__payload {
  ...
  dimension_group: last_note_entry {
    type: time
    timeframes: [
      raw,
      time,
