view: core_profile_service__1__profile_event_v019 {
  sql_table_name: wwi_processed_data.core_profile_service__1__ProfileEvent_v019 ;;
...
view: core_profile_service__1__ProfileEvent_v019__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: core_profile_service__1__ProfileEvent_v019__payload {
  dimension: id {
    primary_key: yes
    type: string
    sql: ${TABLE}.id ;;
...
view: core_profile_service__1__ProfileEvent_v019__payload__identity {
  dimension: classic {
    type: number
    sql: ${TABLE}.classic ;;
  }
...
view: core_profile_service__1__ProfileEvent_v019__payload__additional_settings {
...
view: core_profile_service__1__ProfileEvent_v019__payload__email {
  dimension: personal {
    type: string
    sql: ${TABLE}.personal ;;
  }
...
view: core_profile_service__1__ProfileEvent_v019__payload__address__shipping {
  dimension: country {
    type: string
...
view: core_profile_service__1__ProfileEvent_v019__payload__address__home {
  dimension: country {
    type: string
    map_layer_name: countries
    sql: ${TABLE}.country ;;
...
view: core_profile_service__1__ProfileEvent_v019__payload__phone {
  dimension: home {
    type: string
    sql: ${TABLE}.home ;;
  }
...
view: core_profile_service__1__ProfileEvent_v019__payload__address {
  dimension: home {
    hidden: yes
    sql: ${TABLE}.home ;;
  }
