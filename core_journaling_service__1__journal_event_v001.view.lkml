view: core_journaling_service__1__journal_event_v001 {
  sql_table_name: wwi_processed_data.core_journaling_service__1__JournalEvent_v001 ;;
...
view: core_journaling_service__1__JournalEvent_v001__partitions {
  dimension: day {
    type: string
    sql: ${TABLE}.day ;;
  }
...
view: core_journaling_service__1__JournalEvent_v001__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: core_journaling_service__1__JournalEvent_v001__payload {
  dimension: id {
    primary_key: yes
    type: string
    sql: ${TABLE}.id ;;
