view: champ__meeting_occurrence__1_v004 {
  sql_table_name: wwi_processed_data.champ__MEETING_OCCURRENCE__1_v004 ;;
...
view: champ__MEETING_OCCURRENCE__1_v004__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: champ__MEETING_OCCURRENCE__1_v004__payload {
