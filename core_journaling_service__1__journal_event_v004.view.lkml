view: core_journaling_service__1__journal_event_v004 {
  sql_table_name: wwi_processed_data.core_journaling_service__1__JournalEvent_v004 ;;
...
view: core_journaling_service__1__JournalEvent_v004__partitions {
  dimension: day {
    type: string
    sql: ${TABLE}.day ;;
  }
...
view: core_journaling_service__1__JournalEvent_v004__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: core_journaling_service__1__JournalEvent_v004__payload {
  dimension: id {
    primary_key: yes
    type: string
    sql: ${TABLE}.id ;;
