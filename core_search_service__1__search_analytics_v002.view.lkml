view: core_search_service__1__search_analytics_v002 {
  sql_table_name: wwi_processed_data.core_search_service__1__searchAnalytics_v002 ;;
...
view: core_search_service__1__searchAnalytics_v002__partitions {
  dimension: day {
    type: string
    sql: ${TABLE}.day ;;
  }
...
view: core_search_service__1__searchAnalytics_v002__payload {
...
view: core_search_service__1__searchAnalytics_v002__payload__browsed_details {
  dimension: autocomplete_position {
    type: number
    sql: ${TABLE}.autocompletePosition ;;
  }

  dimension: autocomplete_term {
    type: string
    sql: ${TABLE}.autocompleteTerm ;;
  }
...
view: core_search_service__1__searchAnalytics_v002__payload__tracked_details {
