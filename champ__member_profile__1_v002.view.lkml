view: champ__member_profile__1_v002 {
  sql_table_name: wwi_processed_data.champ__MEMBER_PROFILE__1_v002 ;;
...
view: champ__MEMBER_PROFILE__1_v002__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: champ__MEMBER_PROFILE__1_v002__payload {
