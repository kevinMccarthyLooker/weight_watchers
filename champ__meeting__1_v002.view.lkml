view: champ__meeting__1_v002 {
  sql_table_name: wwi_processed_data.champ__MEETING__1_v002 ;;
...
view: champ__MEETING__1_v002__headers {
  dimension: action {
    type: string
    sql: ${TABLE}.action ;;
  }
...
view: champ__MEETING__1_v002__payload {
  dimension: bankcount {
    type: number
    sql: ${TABLE}.bankcount ;;
  }
